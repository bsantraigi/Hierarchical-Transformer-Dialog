## Joint model
## Independent bw bs, da and tgt(Basic setting)
...
class Joint_model_v3(nn.Module):
	...
	def compute_encoder_output(self, src):
		...
		memory_e1 = memory_inter.view(max_sent_len, -1, batch_size, self.ninp).transpose(0,1).reshape(-1, batch_size, self.ninp)# mdl*msl, bs, embed
