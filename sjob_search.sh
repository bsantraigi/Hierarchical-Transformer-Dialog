...
#SBATCH -o logs/slurm.log          #Name of stdout output file(--output)
#SBATCH -e logs/slurm.log		   #Name of stderr error file(--error)
...
mpirun -bootstrap slurm python search_params.py -e 5 -model HIER
